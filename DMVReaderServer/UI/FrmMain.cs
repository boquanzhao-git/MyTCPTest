...
namespace DMVReaderServer
{
    public partial class Form1 : Form
    {
        ...
        /// 线程辅助对象
        /// </summary>
        DMVReaderServer.ThreadHelper TH = null;
        ...
        public Form1()
        {
            ...
            this.TH = new DMVReaderServer.ThreadHelper(this);
        }
        ...
        private void txtClientProt_TextChanged(object sender, EventArgs e)
        {
